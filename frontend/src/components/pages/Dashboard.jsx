...
>>>>>>> 3fbdb59 (Added routes for create survey, unpublished surveys and analyse survey page)
                </div>
            </div>
...
<<<<<<< HEAD
const PublishedSurveyComponent = () => {
    return <div>
        publishedBlog
=======
